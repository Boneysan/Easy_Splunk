...
: "${APP_METRICS_TARGET:=app:8081}"     # your app’s /metrics endpoint
...
_generate_prometheus_yml() {
  ...
  cat <<EOF | __write_atomic_644 "${PROMETHEUS_CONFIG_FILE}"
...
generate_monitoring_config() {
  ...
  _generate_grafana_dashboard_provider_yml
  _create_placeholder_dashboard
  log_warn "A placeholder dashboard was created. Drop your exported JSON dashboards into '${GRAFANA_DASHBOARDS_DIR}' and restart Grafana."
